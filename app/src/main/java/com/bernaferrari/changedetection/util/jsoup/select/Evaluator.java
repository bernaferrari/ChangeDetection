package com.bernaferrari.changedetection.util.jsoup.select;

import com.bernaferrari.changedetection.util.jsoup.helper.Validate;
import com.bernaferrari.changedetection.util.jsoup.nodes.Comment;
import com.bernaferrari.changedetection.util.jsoup.nodes.Document;
import com.bernaferrari.changedetection.util.jsoup.nodes.DocumentType;
import com.bernaferrari.changedetection.util.jsoup.nodes.Element;
import com.bernaferrari.changedetection.util.jsoup.nodes.Node;
import com.bernaferrari.changedetection.util.jsoup.nodes.PseudoTextElement;
import com.bernaferrari.changedetection.util.jsoup.nodes.TextNode;
import com.bernaferrari.changedetection.util.jsoup.nodes.XmlDeclaration;

import java.util.List;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import static com.bernaferrari.changedetection.util.jsoup.internal.Normalizer.lowerCase;
import static com.bernaferrari.changedetection.util.jsoup.internal.Normalizer.normalize;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.bernaferrari.changedetection.util.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.bernaferrari.changedetection.util.jsoup.nodes.Attribute attribute : values) {
        ...
        public boolean matches(Element root, Element element) {
            ...
            for (TextNode textNode : textNodes) {
                PseudoTextElement pel = new PseudoTextElement(
                        com.bernaferrari.changedetection.util.jsoup.parser.Tag.valueOf(element.tagName()), element.baseUri(), element.attributes());
